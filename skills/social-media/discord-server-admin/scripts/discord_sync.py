...
Run: python3 discord_sync.py
Cron: every 5 minutes via Hermes cron job 'discord-channel-sync' (ID: f5973a47ca58)
Log: /home/rajeev/.hermes/discord_backup/sync.log

IMPORTANT: Data saved to permanent location — survives WSL/system restarts.
If a channel is accidentally deleted, restore from DATA_FILE.
"""
