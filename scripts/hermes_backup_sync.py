...
"""
Hermes Backup Sync
- Watches ~/.hermes/skills, ~/.hermes/scripts, ~/.hermes/discord_backup
- On any change, copies to /home/rajeev/hermes-backup and pushes to GitHub
- Repo: github.com/Rajeevboy/claude-testing (PRIVATE)
- Debounce: 15 seconds after last change
"""
...
# What to watch and where to copy inside the backup repo
...
def sync_files():
    """Copy all source folders into the backup repo."""
...
if __name__ == "__main__":
    ...
    log.info(f"Watching: skills, scripts, discord_backup, SOUL.md")
    log.info(f"Pushing to: github.com/Rajeevboy/claude-testing (private)")
